package cn.handyplus.plugin.command;

import cn.handyplus.lib.annotation.HandyCommand;
import cn.handyplus.lib.command.HandyCommandFactory;
import cn.handyplus.lib.util.BaseUtil;
import cn.handyplus.plugin.constants.TabListEnum;
 ...
 * @author handy
 **/
@HandyCommand(name = "handyPlugin")
public class HandyPluginCommand implements TabExecutor {
    private static final String PERMISSION = "handyPlugin.reload";
